...
# Disable SSL verification and warnings globally for development
...
class ChatService:
    def __init__(self):
        ...
        # Initialize Azure Search client with custom transport
        search_credential = AzureKeyCredential(self.search_key)
        
        # Create custom transport that ignores SSL
